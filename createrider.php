    ...
    <div class="d-flex flex-row">
        ...
        <div class="flex-grow-1">
            <div class="container">
                ...
                <form name="myForm" method="POST" action="dbcreaterider.php">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="row mb-4">
                            ...
                            <div class="row mb-4">
                                <label for="RiderVehicle" class="col-sm-3 col-form-label">Vehicle Type</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="RiderVehicle"
                                        placeholder="Enter Vehicle Type">
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label for="RiderLicensePlate" class="col-sm-3 col-form-label">Plate License</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="RiderLicensePlate"
