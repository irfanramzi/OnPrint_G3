...
<div class="container">
    ...
    <form name="myForm" method="POST" action="dbcreateuser.php">
    <div class="row">
    <div class="col-sm-6">
        <div class="row mb-4">
        ...
        <div class="row mb-4">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="UserFirstName" placeholder="Enter First Name">
            </div>
        </div>
        <div class="row mb-4">
            <label for="UserLastName" class="col-sm-3 col-form-label">Last Name</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" name="UserLastName" placeholder="Enter Last Name">
            </div>
        </div>
        <div class="row mb-4">
    ...
    <div class="col-sm-6">
        ...
        <div class="row mb-4">
            ...
            <div class="col-sm-6">
                <input type="int" class="form-control" name="UserPhone" placeholder="Enter Phone Number">
            </div>
        </div>
        <div class="row mb-4">
